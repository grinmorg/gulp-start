$(function () {
  ...
  $(document).click(function (e) {
    if (
      ...
      $(e.target).closest(".burder-menu").length
    ) {
  ...
  function fixedHeader() {
    let header = $(".header");
    let hederHeight = header.height(); // вычисляю высоту шапки

    if ($(this).scrollTop() > 1) {
      header.addClass("active");
      $("body").css({
        paddingTop: hederHeight + "px", // делаю отступ у body, равный высоте шапки
      });
    } else {
